...
#Analizo de la tabla indicadores ganaderos mensuales la relacion entre
#consumo interno y exportaciones. L
    
#Relacionamos el IPIM y el Dolar con la variacion porcentual entre exportaciones
    #y consumo interno
#Asumimos que el total de ventas va a consumo interno o a exportaciones, por
    #eso porcentualizamos como el total de la suma de esos dos a cada uno.
#HIPOTESIS: Si sube el IPIM sube el consumo interno, si sube el dolar, suben las expos.
#Usamos ggplot y regresiones lineales
    

    
    
#Si no sale la hipotesis es porque las variables que tuvimos en cuenta (dolar e ipim)
    #No son suficientes para explicar las variaciones entre la exportación y el consumo interno
      #