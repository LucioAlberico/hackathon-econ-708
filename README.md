...
Para analizar esto haremos un analisis de regresion entre el Consumo Interno expresado en porcentaje y el IPIM y entre las Exportaciones expresadas como porcentaje del total y el Dolar.
